...
instructively), and are worth recording properly — with the reasoning, not just
the result.

A study earns its place here once it changed a decision in the main project.
Nothing has closed yet — this is a fresh scaffold, and every open question
currently lives in `../experiments/README.md`. See the main
